                            ...
                            <tbody>
                                @foreach ($penjualanDetail as $detail)
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control harga" name="harga[]" readonly
                                                value="{{ $detail->barang->harga_jual }}"></td>
                                        <td><input type="number" class="form-control jumlah" name="jumlah[]" required
                                                value="{{ old('jumlah', $detail->jumlah) }}"></td>
                                        <td>
                                            <input type="number" class="form-control total_harga" name="total_harga[]"
                                                readonly value="{{ old('harga', $detail->harga) }}">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
